// Fallout-MaW боеприпасов migration: one Foundry macro.
// Вставьте весь этот скрипт в один макрос Foundry (Script) и запустите от GM.

const SYSTEM_ID = "fallout-maw";
const BASE_PATH = "systems/fallout-maw/scripts/migration-macros/ammo";
const IMPORT_FILE = "01-import-ammo-items.js";
...
ui.notifications.info("Импорт боеприпасов: старт…");
...
ui.notifications.info("Импорт боеприпасов: завершён.");
