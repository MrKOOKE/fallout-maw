// Fallout-MaW оружия migration: one Foundry macro.
// Вставьте весь этот скрипт в один макрос Foundry (Script) и запустите от GM.

const SYSTEM_ID = "fallout-maw";
const BASE_PATH = "systems/fallout-maw/scripts/migration-macros/weapons";
const IMPORT_FILE = "01-import-weapon-items.js";
...
ui.notifications.info("Импорт оружия: старт…");
...
ui.notifications.info("Импорт оружия: завершён.");
