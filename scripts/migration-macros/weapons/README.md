# Макросы миграции: оружия

Сгенерировано: `2026-07-01T09:47:08.153Z`
...
- 824 предметов из `Оружие / …` старого мира
- Описания не переносятся — характеристики извлекаются парсером
- Включены функции: состояние + оружие с источниками урона по калибру и слотами модулей
...
- `01-import-weapon-items.js` — данные импорта
