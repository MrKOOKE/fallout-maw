// Fallout-MaW снаряжения migration: one Foundry macro.
// Вставьте весь этот скрипт в один макрос Foundry (Script) и запустите от GM.

const SYSTEM_ID = "fallout-maw";
const BASE_PATH = "systems/fallout-maw/scripts/migration-macros/equipment";
const IMPORT_FILE = "01-import-equipment-items.js";
...
ui.notifications.info("Импорт снаряжения: старт…");
...
ui.notifications.info("Импорт снаряжения: завершён.");
