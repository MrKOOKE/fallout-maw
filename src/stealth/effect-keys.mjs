export const STEALTH_ATTACK_ACCURACY_EFFECT_KEY = "system.stealth.attackBonuses.accuracy";
export const STEALTH_ATTACK_CRITICAL_CHANCE_EFFECT_KEY = "system.stealth.attackBonuses.criticalChance";
...
export const STEALTH_ATTACK_BONUS_EFFECT_KEYS = Object.freeze({
  ...
  criticalChance: STEALTH_ATTACK_CRITICAL_CHANCE_EFFECT_KEY,
  damagePercent: STEALTH_ATTACK_DAMAGE_PERCENT_EFFECT_KEY,
  criticalDamagePercent: STEALTH_ATTACK_CRITICAL_DAMAGE_PERCENT_EFFECT_KEY
});
