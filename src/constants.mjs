...
export const TEMPLATES = Object.freeze({
  ...
  perfectFit: `systems/${SYSTEM_ID}/templates/actor/perfect-fit.hbs`,
  qualityService: `systems/${SYSTEM_ID}/templates/actor/quality-service.hbs`,
  ...
  skillCheckBatchChatCard: `systems/${SYSTEM_ID}/templates/chat/skill-check-batch-card.hbs`,
    ...
    firstAidChatCard: `systems/${SYSTEM_ID}/templates/chat/first-aid-card.hbs`,
  ...
  settings: Object.freeze({
    ...
    camp: `systems/${SYSTEM_ID}/templates/settings/camp-settings-config.hbs`,
    campPlace: `systems/${SYSTEM_ID}/templates/settings/camp-place-settings-config.hbs`,
    ...
    settingsPresets: `systems/${SYSTEM_ID}/templates/settings/settings-presets-config.hbs`
  })
});
