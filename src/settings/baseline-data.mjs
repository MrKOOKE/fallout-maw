export const SETTINGS_BASELINE_VERSION = 1;
  ...
  "settings": {
                      ...
                      "conditions": [
                        {
                          "id": "j03C4sx6pbDZYJ5k",
                          "groupId": "",
                          "type": "equipmentSlotOccupied",
                          "operator": "occupied",
                          "equipmentSlotKey": "glasses",
                          "percent": 50,
                  ...
                  "functions": [
                    {
                      ...
                      "changes": [
                        ...
                        {
                          "id": "BF2mlLL0a6CnsOXb",
                          "key": "system.costs.actions.burst",
                          "type": "add",
                          "value": "-1",
                          "phase": "initial",
                          "priority": null
                  ...
                  "functions": [
                    {
                      ...
                      "changes": [
                        {
                          "id": "E6PdFug0e9LD8Tnx",
                          "key": "system.costs.actions.aimedShot",
                          "type": "add",
                          "value": "-1",
                          "phase": "initial",
                          "priority": null
                  ...
                  "functions": [
                    {
                      ...
                      "changes": [
                        {
                          "id": "eGNLdGoSQplh117m",
                          "key": "system.costs.actions.aimedMeleeAttack",
                          "type": "add",
                          "value": "-1",
                          "phase": "initial",
                          "priority": null
                        ...
                        {
                          "id": "gfSAqI1axEE5JqY1",
                          "key": "system.costs.actions.meleeAttack",
                          "type": "add",
                          "value": "-1",
                          "phase": "initial",
                          "priority": null
                  ...
                  "functions": [
                    {
                      ...
                      "changes": [
                        ...
                        {
                          "id": "C480NVWPMvC1C3S2",
                          "key": "system.inventory.rowsBonus",
                          "type": "add",
                          "value": "1",
                          "phase": "initial",
                          "priority": null
                  ...
                  "functions": [
                    {
                      ...
                      "changes": [
                        ...
                        {
                          "id": "qDc8bbCqpF4yoe0c",
                          "key": "system.inventory.columnsBonus",
                          "type": "add",
                          "value": "2",
                          "phase": "initial",
                          "priority": null
                  ...
                  "functions": [
                    {
                      ...
                      "changes": [
                        {
                          "id": "e0ygwqRNFug7lrGp",
                          "key": "system.combat.burstStability",
                          "type": "add",
                          "value": "50",
                          "phase": "initial",
                          "priority": null
                  ...
                  "functions": [
                    {
                      ...
                      "changes": [
                        {
                          "id": "qcvQHQz9Ivj64lcA",
                          "key": "system.healing.outgoingPercent",
                          "type": "add",
                          "value": "25",
                          "phase": "initial",
                          "priority": null
        ...
        "races": [
          {
            ...
            "baseParameters": {
              ...
              "loadFormula": "20 + 10*str",
              "loadLimitPercent": 150
            },
            "limbs": [
              {
                "key": "head",
      ...
      "value": [
        {
          "key": "caps",
          "label": "Крышки",
          "img": "systems/fallout-maw/assets/currencies/caps.webp",
          "value": 1
        },
        {
          "key": "denarii",
          "label": "Динарии",
          "img": "systems/fallout-maw/assets/currencies/denarii.webp",
          "value": 2
        },
        {
          "key": "ncrDollars",
          "label": "Доллары НКР",
          "img": "systems/fallout-maw/assets/currencies/ncrDollars.webp",
          "value": 3
        },
        {
          "key": "brotherhoodChecks",
          "label": "Чеки братства",
          "img": "systems/fallout-maw/assets/currencies/brotherhoodChecks.webp",
          "value": 6
        }
      ]
    },
    ...
    "fallout-maw.personalNameRandomizer": {
      ...
      "value": {
        "blocks": [
          {
            "id": "default-male-names",
            "name": "Мужские имена",
            "namesText": "Аарон, Адам, Артур, Виктор, Даниил, Илья, Максим, Роман"
          },
          {
            "id": "default-female-names",
            "name": "Женские имена",
            "namesText": "Анна, Алиса, Виктория, Дарья, Елена, Ирина, Мария, София"
          },
          {
            "id": "default-surnames-common",
            "name": "Простые фамилии",
            "namesText": "Смит, Браун, Миллер, Уилсон, Кларк, Уокер, Холл, Янг"
          },
          {
            "id": "default-surnames-noble",
            "name": "Знатные фамилии",
            "namesText": "Блэквуд, Фэрфакс, Уиндзор, Кавендиш, Монтгомери, Равенскрофт"
          }
        ]
      }
    },
    ...
    "fallout-maw.portraitImageBackground": {
      "scope": "world",
      "value": "ui/denim075.png"
    },
    "fallout-maw.portraitImageBorder": {
      "scope": "world",
      "value": "systems/fallout-maw/assets/combat-carousel/border.png"
    },
    ...
    "fallout-maw.proficiencySettings": {
      ...
      "value": {
        "entries": [
          ...
          {
            "key": "oneHandedSlashing",
            "abbr": "ohs",
            "label": "Одноручное режущее",
            "max": 1000
          },
          {
            "key": "twoHandedSlashing",
            "abbr": "ths",
            "label": "Двуручное режущее",
            "max": 1000
          },
          {
            "key": "oneHandedPiercing",
            "abbr": "ohp",
            "label": "Одноручное колющее",
            "max": 1000
          },
          {
            "key": "twoHandedPiercing",
            "abbr": "thp",
            "label": "Двуручное колющее",
            "max": 1000
          },
          {
            "key": "oneHandedBludgeoning",
            "abbr": "ohb",
            "label": "Одноручное дробящее",
            "max": 1000
          },
          {
            "key": "twoHandedBludgeoning",
            "abbr": "thb",
    ...
    "fallout-maw.resourceSettings": {
      ...
      "value": [
        ...
        },
        {
          ...
          "abbr": "act",
          "label": "Очки действия",
          "formula": "5 + (dex/3 + str/5)",
          "color": "#74b84e"
        },
        {
          "key": "movementPoints",
          "abbr": "mov",
          "label": "Очки передвижения",
          "formula": "5 + ath/30",
          "color": "#d7b14a"
        }
      ]
      ...
      "value": {
        "entries": [
          ...
          },
          {
            ...
            "abbr": "ath",
            "label": "Атлетика",
            "formula": "10 + (dex + str)*2",
            "img": "icons/svg/d20-grey.svg"
          },
          {
            "key": "energy",
            "abbr": "ene",
            "label": "Контроль энергии",
            "formula": "int*4",
            "img": "icons/svg/d20-grey.svg"
          },
          {
    ...
    "fallout-maw.toolSettings": {
      ...
      "value": [
        {
          "key": "medical",
          "label": "Инструменты медицины"
        },
        {
          "key": "repair",
          "label": "Инструменты ремонта"
        },
        {
          "key": "electronicHacking",
          "label": "Инструменты электронного взлома"
        },
        {
          "key": "mechanicalHacking",
          "label": "Инструменты механического взлома"
        }
      ]
    },
