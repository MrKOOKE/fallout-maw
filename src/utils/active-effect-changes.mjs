...
const ALL_SKILLS_EFFECT_FIELDS = Object.freeze({
  ...
  [ALL_SKILLS_BONUS_PERCENT_EFFECT_KEY]: "bonusPercent",
  [ALL_SKILLS_ADVANTAGE_EFFECT_KEY]: "advantage",
  [ALL_SKILLS_DISADVANTAGE_EFFECT_KEY]: "disadvantage",
  [ALL_SKILLS_CRITICAL_SUCCESS_CHANCE_EFFECT_KEY]: "criticalSuccessChance",
  [ALL_SKILLS_CRITICAL_FAILURE_CHANCE_EFFECT_KEY]: "criticalFailureChance"
});
