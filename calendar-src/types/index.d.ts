export import FalloutMaWCalendar = globalThis.FalloutMaWCalendar;
...
declare global {
    /**
     * The `FalloutMaWCalendar` namespace is used to house all functionality that other modules, systems and macros can access for interacting with the Simple Calendar module.
     */
    namespace FalloutMaWCalendar {
        /**
         * The `FalloutMaWCalendar.api` namespace contains functions and properties used to update the Simple Calendar module or get information from it.
         */
        namespace api {
            ...
            /**
             * This function is used to activate event listeners for calendars displayed with the {@link HandlebarHelpers.fallout-maw-calendar-full-calendar}.
             *
             * If being used in a FoundryVTT application or FormApplication it is best called in the activateListeners function.
             * @param calendarId The ID of the HTML element of the calendar to activate listeners for. This is the same ID used in the {@link HandlebarHelpers.fallout-maw-calendar-full-calendar}.
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.activateFullCalendarListeners('example_1');
             * ```
             */
             ...
             * @example
             * ```javascript
             * const newJournal = await FalloutMaWCalendar.api.addNote('Christmas Day','Presents!', {year: 2022, month: 11, day: 24, hour: 0, minute: 0, seconds: 0}, {year: 2022, month: 11, day: 24, hour: 0, minute: 0, seconds: 0}, true, FalloutMaWCalendar.api.NoteRepeat.Yearly, ['Holiday']);
            ...
            export async function addNote(
                title: string,
                content: string,
                startDate: FalloutMaWCalendar.DateTimeParts,
                endDate: FalloutMaWCalendar.DateTimeParts,
                allDay: boolean,
             ...
             * FalloutMaWCalendar.api.addSidebarButton("My Module", "fa-computer-mouse", "my-custom-class", true, populateSidePanel);
             *
             * // Adding a button that will show a dialog when clicked
             * FalloutMaWCalendar.api.addSidebarButton("My Module", "fa-computer-mouse", "my-custom-class", false, sidePanelButtonClick);
             *
             * ```
             */
             ...
             * FalloutMaWCalendar.api.advanceTimeToPreset(FalloutMaWCalendar.api.PresetTimeOfDay.Sunset);
             *
             ...
             * FalloutMaWCalendar.api.advanceTimeToPreset(FalloutMaWCalendar.api.PresetTimeOfDay.Sunrise);
             * ```
             */
             ...
             * FalloutMaWCalendar.api.changeDate({day: 1}); // Will set the new date to June 2, 2021
             *
             * //Assuming a date of June 1, 2021 and user has permission to change the date
             * FalloutMaWCalendar.api.changeDate({day: -1}); // Will set the new date to May 31, 2021
             *
             * //Assuming a date of June 1, 2021 10:00:00 and user has permission to change the date
             * FalloutMaWCalendar.api.changeDate({year: 1, month: 1, day: 1, hour: 1, minute: 1, seconds: 1}); // Will set the new date to July 2, 2022 11:01:01
             *
             * //Assuming a date of June 1, 2021 10:00:00 and user has permission to change the date
             * FalloutMaWCalendar.api.changeDate({seconds: 3600}); // Will set the new date to June 1, 2021 11:00:00
             * ```
             */
            export function changeDate(interval: FalloutMaWCalendar.DateTimeParts, calendarId: string = "active"): boolean;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.chooseRandomDate({year: 2021, month: 3, day: 0}, {year: 2021, month: 5, day: 1})
             *
             * // {
             * //     day: 1
             * //     hour: 12
             ...
             * // }
             *
             FalloutMaWCalendar.api.chooseRandomDate({year: 1900, month: 3}, {year: 2021, month: 5})
             * // {
             * //     day: 19
             * //     hour: 8
             * //     minute: 16
             ...
             * // }
             *
             * FalloutMaWCalendar.api.chooseRandomDate();
             * // {
             * //     day: 11
             * //     hour: 0
             * //     minute: 49
            ...
            export function chooseRandomDate(
                startingDate: FalloutMaWCalendar.DateTimeParts = {},
                endingDate: FalloutMaWCalendar.DateTimeParts = {},
                calendarId: string = "active"
            ): FalloutMaWCalendar.DateTime;
             ...
             * @example
             * ```javascript
             * const status = FalloutMaWCalendar.api.clockStatus();
             * console.log(status); // {started: false, stopped: true, paused: false}
             * ```
             */
            export function clockStatus(calendarId: string = "active"): FalloutMaWCalendar.ClockStatus;

            /**
             * Sets up the current calendar to match the passed in configuration. This function can only be run by GMs.
             * @param calendarData The configuration to set the calendar to. It can be one of the predefined calendars or a {@link FalloutMaWCalendar.CalendarData} object representing a custom calendar.
             ...
             * const result = await FalloutMaWCalendar.api.configureCalendar(FalloutMaWCalendar.api.Calendars.Gregorian);
             *
             * //Set the calendar configuration to a custom calendar
             * const custom = {};
             *
             * const result = await FalloutMaWCalendar.api.configureCalendar(custom);
             * ```
             */
            export async function configureCalendar(
                calendarData: PredefinedCalendars | FalloutMaWCalendar.CalendarData,
                calendarId: string = "active"
            ): Promise<boolean>;
             ...
             * FalloutMaWCalendar.api.currentDateTime();
             ...
             * ```
             */
            export function currentDateTime(calendarId: string = "active"): FalloutMaWCalendar.DateTime | null;
             ...
             * ```javascript
             * // Assuming a Gregorian calendar
             * FalloutMaWCalendar.api.currentDateTimeDisplay();
             * //Returns a DateTime object like this
             * // {
             * //     date: "June 01, 2021",
             * //     day: "1",
             ...
             * ```
             */
            export function currentDateTimeDisplay(calendarId: string = "active"): FalloutMaWCalendar.DateDisplayData | null;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.dateToTimestamp({}); //Returns the timestamp for the current date
             *
             * FalloutMaWCalendar.api.dateToTimestamp({year: 2021, month: 0, day: 0, hour: 1, minute: 1, seconds: 0}); //Returns 1609462860
             * ```
             */
            export function dateToTimestamp(date: FalloutMaWCalendar.DateTimeParts, calendarId: string = "active"): number;
             ...
             *
             * FalloutMaWCalendar.api.formatDateTime({year: 2021, month: 11, day: 24, hour: 12, minute: 13, seconds: 14});
             * // Returns {date: 'December 25, 2021', time: '12:13:14'}
             *
             * FalloutMaWCalendar.api.formatDateTime({year: -2021, month: -11, day: 24, hour: 12, minute: 13, seconds: 14})
             * // Returns {date: 'January 25, -2021', time: '12:13:14'}
             *
             * FalloutMaWCalendar.api.formatDateTime({year: 2021, month: 111, day: 224, hour: 44, minute: 313, seconds: 314})
             * // Returns {date: 'December 31, 2021', time: '23:59:59'}
             *
             * FalloutMaWCalendar.api.formatDateTime({year: 2021, month: 111, day: 224, hour: 44, minute: 313, seconds: 314},"DD/MM/YYYY HH:mm:ss A")
             * // Returns "31/12/2021 23:59:00 PM"
             * ```
             */
            export function formatDateTime(
                date: FalloutMaWCalendar.DateTimeParts,
                format: string = "",
                calendarId: string = "active"
             ...
             * // Time: 24Hour:Minute:Second
             *
             * FalloutMaWCalendar.api.formatTimestamp(1640434394);
             * // Returns {date: 'December 25, 2021', time: '12:13:14'}
             *
             * FalloutMaWCalendar.api.formatTimestamp(1640434394,"DD/MM/YYYY HH:mm:ss A");
             ...
             * @example
             * ```javascript
             * const c = FalloutMaWCalendar.api.getAllCalendars();
             * console.log(c); // Will contain a list of all calendars and their data
             * ```
             */
            export function getAllCalendars(): FalloutMaWCalendar.CalendarData[];
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getAllMonths();
             ...
             * ```
             */
            export function getAllMonths(calendarId: string = "active"): FalloutMaWCalendar.MonthData[];
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getAllMoons();
             * // Returns an array like this, assuming the Gregorian Calendar
             * // [
             * //     {
             * //         "id": "2c26abfa",
             ...
             * ```
             */
            export function getAllMoons(calendarId: string = "active"): FalloutMaWCalendar.MoonData[];
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getAllSeasons();
             * // Returns an array like this, assuming the Gregorian Calendar
             * // [
             * //     {
             * //         color: "#fffce8",
             ...
             * ```
             */
            export function getAllSeasons(calendarId: string = "active"): FalloutMaWCalendar.SeasonData[];
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getAllThemes();
             * // {
             * //    "dark": "Dark",
             * //    "light": "Light",
             * //    "classic": "Classic"
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getAllWeekdays();
             * // Returns an array like this, assuming the Gregorian Calendar
             * // [
             * //     {
             * //         id: "dafbfd4",
             ...
             * ```
             */
            export function getAllWeekdays(calendarId: string = "active"): FalloutMaWCalendar.WeekdayData[];
             ...
             * @example
             * ```javascript
             * cosnt c = FalloutMaWCalendar.api.getCurrentCalendar();
             * console.log(c); // Will contain all the configuration data for the current calendar.
             * ```
             */
            export function getCurrentCalendar(): FalloutMaWCalendar.CalendarData;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getCurrentDay();
             ...
             * ```
             */
            export function getCurrentDay(calendarId: string = "active"): FalloutMaWCalendar.DayData | null;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getCurrentMonth();
             * // Returns an object like this:
             * // {
             * //     abbreviation: "Jun",
             * //     id: "22b4b204",
             ...
             * ```
             */
            export function getCurrentMonth(calendarId: string = "active"): FalloutMaWCalendar.MonthData | null;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getCurrentSeason();
             * // Returns an object like this
             * // {
             * //     color: "#fffce8",
             * //     id: "4916a231",
             ...
             * ```
             */
            export function getCurrentSeason(calendarId: string = "active"): FalloutMaWCalendar.SeasonData;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getCurrentTheme();
             * // Returns "dark"
             * ```
             */
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getCurrentWeekday();
             * // Returns an object like this
             * // {
             * //     id: "b40f3a20",
             * //     name: "Tuesday",
             ...
             * ```
             */
            export function getCurrentWeekday(calendarId: string = "active"): FalloutMaWCalendar.WeekdayData | null;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getCurrentYear();
             * // Returns an object like this
             * // {
             * //     firstWeekday: 4,
             * //     id: "bbe5385c",
             ...
             * ```
             */
            export function getCurrentYear(calendarId: string = "active"): FalloutMaWCalendar.YearData | null;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getLeapYearConfiguration();
             * // Returns an object like this
             * // {
             * //     customMod: 0,
             * //     id: "1468d034",
             ...
             * ```
             */
            export function getLeapYearConfiguration(calendarId: string = "active"): FalloutMaWCalendar.LeapYearData | null;
             ...
             * FalloutMaWCalendar.api.getNotes();
             *```
             */
             ...
             * ```javascript
             * // Returns an array of JournalEntry objects
             * FalloutMaWCalendar.api.getNotesForDay(2022, 11, 24);
             * ```
             */
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.getTimeConfiguration();
             * // Returns an object like this
             * // {
             * //     gameTimeRatio: 1,
             * //     hoursInDay: 24,
             ...
             * ```
             */
            export function getTimeConfiguration(calendarId: string = "active"): FalloutMaWCalendar.TimeData | null;
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.isOpen(); // True or false depending on if the calendar is open or closed.
             * ```
             */
             ...
             * ```javascript
             *
             * FalloutMaWCalendar.api.isPrimaryGM(); //True or Flase depending on if the current user is primary gm
             *
             * ```
             */
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.pauseClock();
             * ```
             */
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.removeNote("asd123").then(...).catch(console.error);
             * ```
             */
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.searchNotes("Note"); //Will return a list of notes that contained the word note somewhere in its content.
             *
             * FalloutMaWCalendar.api.searchNotes("Note", {title: true}); // Will return a list of notes that contain the world note in the title.
             *
             * FalloutMaWCalendar.api.searchNotes("Gamemaster", {author: true}); // Will return a list of notes that were written by the gamemaster.
             * ```
             */
             ...
             * ```javascript
             * //Assuming a Gregorian Calendar
             * FalloutMaWCalendar.api.secondsToInterval(3600); //Returns {year: 0, month: 0, day: 0, hour: 1, minute: 0, seconds: 0}
             * FalloutMaWCalendar.api.secondsToInterval(3660); //Returns {year: 0, month: 0, day: 0, hour: 1, minute: 1, seconds: 0}
             * FalloutMaWCalendar.api.secondsToInterval(86400); //Returns {year: 0, month: 0, day: 1, hour: 0, minute: 0, seconds: 0}
             * FalloutMaWCalendar.api.secondsToInterval(604800); //Returns {year: 0, month: 0, day: 7, hour: 0, minute: 0, seconds: 0}
             * FalloutMaWCalendar.api.secondsToInterval(2629743); //Returns {year: 0, month: 1, day: 0, hour: 10, minute: 29, seconds: 3}
             * FalloutMaWCalendar.api.secondsToInterval(31556926); //Returns {year: 1, month: 0, day: 0, hour: 5, minute: 48, seconds: 46}
             * ```
             */
            export function secondsToInterval(seconds: number, calendarId: string = "active"): FalloutMaWCalendar.DateTimeParts;
             ...
             * FalloutMaWCalendar.api.setDate({year: 1999, month: 11, day: 24, hour: 0, minute: 0, seconds: 0});
             *
             * //To set the date to December 31st 1999 and the time to 11:59:59pm
             * FalloutMaWCalendar.api.setDate({year: 1999, month: 11, day: 30, hour: 23, minute: 59, seconds: 59});
             * ```
             */
            export function setDate(date: FalloutMaWCalendar.DateTimeParts, calendarId: string = "active"): boolean;
             ...
             *
             * @param themeId The ID of the theme to set. The ID's of all available themes can be found using {@link FalloutMaWCalendar.api.getAllThemes}.
             *
             ...
             * ```javascript
             *
             * await FalloutMaWCalendar.api.setTheme('light');
             ...
             *
             * await FalloutMaWCalendar.api.setTheme('themeDoesNotExist');
             ...
             * ```javascript
             * //Assuming a Gregorian Calendar
             * FalloutMaWCalendar.api.showCalendar(); // Will open the calendar to the current date.
             * FalloutMaWCalendar.api.showCalendar({year: 1999, month: 11, day: 25}); // Will open the calendar to the date December 25th, 1999
             * FalloutMaWCalendar.api.showCalendar(null, true); // Will open the calendar to the current date in compact mode.
             * ```
             */
            export function showCalendar(
                date: FalloutMaWCalendar.DateTimeParts | null = null,
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.startClock();
             * ```
             */
             ...
             * @example
             * ```javascript
             * FalloutMaWCalendar.api.stopClock();
             * ```
             */
             ...
             * @example
             * ```javascript
             * const timestamp = FalloutMaWCalendar.api.timestamp();
             ...
             * @example
             * ```javascript
             * let newTime = FalloutMaWCalendar.api.timestampPlusInterval(0, {day: 1});
             ...
             * newTime = FalloutMaWCalendar.api.timestampPlusInterval(1622505600, {month: 1, day: 1});
             * console.log(newTime); // This will be the number of seconds that equal July 2nd 2021
             * ```
             */
            export function timestampPlusInterval(
                currentSeconds: number,
                interval: FalloutMaWCalendar.DateTimeParts,
                calendarId: string = "active"
            ): number;

            /**
             * Converts a timestamp (in seconds) into a {@link FalloutMaWCalendar.DateData} objet from the specified calendar
             * @param seconds The timestamp (in seconds) to convert into a date object.
             * @param calendarId Optional parameter to specify the ID of the calendar to use to calculate the {@link FalloutMaWCalendar.DateData} objet. If not provided the current active calendar will be used.
             *
             ...
             * ```javascript
             * // Assuming Gregorian Calendar with the current date of June 1, 2021
             * let falloutMawCalendarDate = FalloutMaWCalendar.api.timestampToDate(1622505600);
             * console.log(falloutMawCalendarDate);
             ...
             * ```
             */
            export function timestampToDate(seconds: number, calendarId: string = "active"): FalloutMaWCalendar.DateData | null;
            export function timestampToDateParts(seconds: number, calendarId?: string): {
                year: number;
                month: number;
                day: number;
                hour: number;
                ...
                dayOfTheWeek: number;
                isLeapYear: boolean;
                currentSeason: FalloutMaWCalendar.SeasonData | null;
            } | null;
            export function getMoonLightingState(calendarId?: string): Array<{
                name: string;
                color: string;
                cycleLength: number;
                cycleDayAdjust: number;
                affectsLighting: boolean;
                maxLightContribution: number;
                currentPhase: FalloutMaWCalendar.MoonPhase;
            }>;
        }
        ...
        namespace DateTimeSelector {
            ...
            interface Options {
                ...
                onDateSelect?: (selectedDates: FalloutMaWCalendar.DateTimeSelector.SelectedDates) => void;
        ...
        namespace Renderer {
            ...
            export interface CalendarOptions {
                ...
                selectedDates?: {
                    /** The selected starting date */
                    start: FalloutMaWCalendar.Date;
                    /** The selected ending date */
                    end: FalloutMaWCalendar.Date;
                };
            ...
            export interface TimeSelectorOptions {
                ...
                selectedTime?: {
                    ...
                    start: FalloutMaWCalendar.Time;
                    /** The selected ending time */
                    end: FalloutMaWCalendar.Time;
                };
         ...
         * @internal
         */
        namespace FalloutMaWCalendarSocket {
            /**
        ...
        interface FirstNewMoonDate {
            /** If and when the year of the new moon should be reset. {@link FalloutMaWCalendar.api.MoonYearResetOptions | List of options}*/
        ...
        interface MoonData extends IDataItemBase {
            ...
            cycleDayAdjust: number;
            /** If this moon contributes light to the scene darkness calculation. */
            affectsLighting: boolean;
            /** Maximum darkness reduction contributed by this moon, from 0 to 1. */
            maxLightContribution: number;
        }
        ...
        interface MoonPhase {
            ...
            icon: Icons;
            /** How brightly this phase shines, from 0 (dark) to 1 (fully illuminated). */
            illumination: number;
        }
    ...
    enum HandlebarHelpers {
         ...
         *
         * @remarks
         * Don't forget to call the {@link FalloutMaWCalendar.api.activateFullCalendarListeners} function for any calendars that should be interactive. Static displays do not need to call this function.
         ...
         * - wrap them handlebar helper in a div with the 'fallout-maw-calendar' class (if you wish to keep the same structure for the calendar) `<div class="fallout-maw-calendar"></div>`
         ...
         * @example Default
         * ```html
         * {{fallout-maw-calendar-full-calendar id='custom_id'}}
         * ```
         * ![Default Example](media://fallout-maw-calendar-full-calendar-example-default.png)
         *
         * @example All Options Disabled
         * ```html
         * {{fallout-maw-calendar-full-calendar id='custom_id' colorToMatchSeason=false showCurrentDate=false showSeasonName=false showNoteCount=false showMoonPhases= false showYear=false}}
         * ```
         * ![All Disabled Example](media://fallout-maw-calendar-full-calendar-example-all-disabled.png)
         *
         ...
         * ```
         * ```html
         * {{fallout-maw-calendar-full-calendar id='custom_id' date=newDate }}
         * ```
         * ![Specific Date Example](media://fallout-maw-calendar-full-calendar-example-set-date.png)
         *
         ...
         * ```html
         * {{fallout-maw-calendar-full-calendar id='custom_id' theme='light' }}
         * ```
         * ![Set Theme Example](media://fallout-maw-calendar-full-calendar-example-set-theme.png)
         */
        "fallout-maw-calendar-full-calendar",
        /**
         ...
         * **Styling**:
         *
         * To use the default styles for the date selector be sure to add the class `fallout-maw-calendar` to the div that contains this handlebar helper. If this is not included then you will be responsible for creating the styles for the date selector.
         *
         * **Examples**:
         */
        //"fallout-maw-calendar-date-selector",
        /**
         ...
         *
         * @remarks The clock does not automatically update. Listening to the {@link FalloutMaWCalendar.Hooks.DateTimeChange} hook would allow you to refresh the clock display.
         *
         * **Parameters**
         *
         ...
         * ```html
         * {{fallout-maw-calendar-clock id='unique_id' }}
         * ```
         * ![Clock](media://fallout-maw-calendar-clock-example.png)
         *
         * @example Specified Theme
         *
         ...
         * ```html
         * {{fallout-maw-calendar-clock id='unique_id' theme='light'}}
         * ```
         * ![Clock Set Theme](media://fallout-maw-calendar-clock-example-set-theme.png)
         *
         * @example Specific Calendar
         * ```html
         * {{fallout-maw-calendar-clock id='unique_id' calendarId='b74474f7' }}
         * ```
         */
        "fallout-maw-calendar-clock",
        /**
         * This handlebar helper is used to render one of the icons included with Simple Calendar.
         *
         * **Parameters**
         *
         * - **name:** *{@link FalloutMaWCalendar.api.Icons}*<br/>Which icon to display.<br/><br/>
         ...
         * ```html
         * {{fallout-maw-calendar-icon name='clock' }}
         * ```
         * ![Display an Icon](media://fallout-maw-calendar-icon-example-default.png)
         *
         * @example Display a custom colored Icon
         * ```html
         * {{fallout-maw-calendar-icon name='clock' fill='#ff0000' stroke='#ff0000' }}
         * ```
         * ![Display a custom colored Icon](media://fallout-maw-calendar-icon-example-color.png)
         */
        "fallout-maw-calendar-icon"
    }

    interface FlagConfig {
        JournalEntry: {
            "fallout-maw": {
                noteData?: FalloutMaWCalendar.NoteData;
            }
        };
        Folder: {
            "fallout-maw": {
        ...
        ChatMessage: {
            "fallout-maw": {
                calendarTimestamps?: { id: string; timestamp: number };
            }
        }
    }

    interface SettingConfig {
        [key: `fallout-maw.${string}.calendar.theme`]: string;
        "fallout-maw.calendar.theme": string;
        "fallout-maw.calendar.open-on-load": boolean;
        "fallout-maw.calendar.open-compact": boolean;
        "fallout-maw.calendar.remember-position": boolean;
        "fallout-maw.calendar.remember-compact-position": boolean;
        "fallout-maw.calendar.app-position": Record<string, unknown>;
        "fallout-maw.calendar.app-compact-position": Record<string, unknown>;
        "fallout-maw.calendar.note-reminder-notification": string;
        "fallout-maw.calendar.note-list-open-direction": string;
        "fallout-maw.calendar.always-show-note-list": boolean;
        "fallout-maw.calendar.persistent-open": boolean;
        "fallout-maw.calendar.compact-view-scale": number;
        "fallout-maw.calendar.main-app": unknown;
        "fallout-maw.calendar.configuration-menu": unknown;
        "fallout-maw.calendar.configuration": unknown[];
        "fallout-maw.calendar.active": string;
        "fallout-maw.calendar.global-configuration": Record<string, unknown>;
        "fallout-maw.calendar.clock-state": string;
        "fallout-maw.calendar.clock-time": Record<string, number>;
    }
}
...
declare module "@league-of-foundry-developers/foundry-vtt-types/configuration" {
    namespace Hooks {
        interface HookConfig {
            "fallout-maw.calendar.date-time-change": (...args: unknown[]) => void,
            "fallout-maw.calendar.configuration-change": (...args: unknown[]) => void,
            "fallout-maw.calendar.clock-start-stop": (...args: unknown[]) => void,
            "fallout-maw.calendar.primary-gm": (...args: unknown[]) => void,
            "fallout-maw.calendar.ready": (...args: unknown[]) => void,
            "fallout-maw.calendar.init": (...args: unknown[]) => void,
