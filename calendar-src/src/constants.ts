 ...
 * @internal
 */
export const ModuleName = "fallout-maw";
/**
 * The system socket. Foundry systems use the `system.*` channel.
 * @internal
 */
export const ModuleSocketName = `system.${ModuleName}`;
...
export enum SettingNames {
    ...
    OpenOnLoad = "calendar.open-on-load",
    OpenCompact = "calendar.open-compact",
    RememberPosition = "calendar.remember-position",
    RememberCompactPosition = "calendar.remember-compact-position",
    AppPosition = "calendar.app-position",
    AppCompactPosition = "calendar.app-compact-position",
    NoteReminderNotification = "calendar.note-reminder-notification",
    NoteListOpenDirection = "calendar.note-list-open-direction",
    AlwaysShowNoteList = "calendar.always-show-note-list",
    PersistentOpen = "calendar.persistent-open",

    CompactViewScale = "calendar.compact-view-scale",
    ...
    GlobalConfiguration = "calendar.global-configuration",
    ClockState = "calendar.clock-state",
    ClockTime = "calendar.clock-time"
}
 ...
 * @internal
 */
export const Themes: FalloutMaWCalendar.Theme[] = [
    {
        key: "dark",
        name: "FALLOUTMAW.Calendar.Configuration.Theme.Dark",
        system: false,
        module: false
    },
    {
        key: "light",
        name: "FALLOUTMAW.Calendar.Configuration.Theme.Light",
        system: false,
        module: false
    },
    {
        key: "classic",
        name: "FALLOUTMAW.Calendar.Configuration.Theme.Classic",
        system: false,
        module: false
    },
    {
        key: "wfrp4e",
        name: "FALLOUTMAW.Calendar.Configuration.Theme.WFRP4E",
        system: true,
        module: false,
        images: {
    ...
    {
        key: "forbidden-lands",
        name: "FALLOUTMAW.Calendar.Predefined.ForbiddenLands",
        system: true,
        module: false,
        images: {
    ...
    {
        key: "dsa5",
        name: "FALLOUTMAW.Calendar.Predefined.DSA-TDE5e",
        system: true,
        module: false,
        images: {
    ...
    {
        key: "sfrpg",
        name: "FALLOUTMAW.Calendar.Predefined.Starfinder",
        system: true,
        module: false,
        images: {
    ...
    {
        key: "wrath-and-glory",
        name: "FALLOUTMAW.Calendar.Predefined.Warhammer40kWG",
        system: true,
        module: false,
        images: {
    ...
    {
        key: "eclipsephase",
        name: "FALLOUTMAW.Calendar.Predefined.EclipsePhase",
        system: true,
        module: false,
        images: {
    ...
    },
    {
        ...
        name: "FALLOUTMAW.Calendar.Configuration.Theme.Cyberpunk-Red",
        system: true,
        module: false
    }
...
export const NotesDirectoryName = `_fallout_maw_calendar_notes_directory`;
...
export enum SocketTypes {
    mainAppUpdate = "calendar.main-app-update",
    clock = "calendar.clock",
    checkClockRunning = "calendar.check-clock-running",
    journal = "calendar.journal",
    dateTimeChange = "calendar.date-time-change",
    noteUpdate = "calendar.note-update",
    emitHook = "calendar.emit-hook",
    setActiveCalendar = "calendar.set-calendar",
    renderChatLog = "calendar.render-chat-log"
}
...
/**
 * All SVG icons that are available to use with the fallout-maw-calendar-icon handlebar helper
 */
export enum Icons {
    /** An empty Icon */
    None = "none",
 ...
 */
export enum FalloutMaWCalendarHooks {
    DateTimeChange = "fallout-maw.calendar.date-time-change",
    ConfigurationChange = "fallout-maw.calendar.configuration-change",
    ClockStartStop = "fallout-maw.calendar.clock-start-stop",
    PrimaryGM = "fallout-maw.calendar.primary-gm",
    Ready = "fallout-maw.calendar.ready",
    Init = "fallout-maw.calendar.init"
}
