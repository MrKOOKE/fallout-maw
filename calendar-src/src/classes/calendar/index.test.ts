...
import { CalManager, MainApplication, updateCalManager, updateMainApplication, updateNManager, updateSC } from "../index";
...
const setActiveGM = (isSelf: boolean) => {
    Object.defineProperty((<Game>game).users, "activeGM", {
        configurable: true,
        value: isSelf ? (<Game>game).user : undefined
    });
};
