...
export class Weekday extends ConfigurationItemBase {
     ...
     */
    toConfig(): FalloutMaWCalendar.WeekdayData {
        return {
     ...
     */
    toTemplate(): FalloutMaWCalendar.HandlebarTemplateData.Weekday {
        return {
            ...super.toTemplate(),
            abbreviation: this.abbreviation,
            name: this.name,
     ...
     */
    loadFromSettings(config: FalloutMaWCalendar.WeekdayData) {
