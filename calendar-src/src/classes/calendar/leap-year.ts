...
export default class LeapYear extends ConfigurationItemBase {
     ...
     */
    toConfig(): FalloutMaWCalendar.LeapYearData {
        return {
            id: this.id,
            rule: this.rule,
     ...
     */
    toTemplate(): FalloutMaWCalendar.HandlebarTemplateData.LeapYearTemplate {
        return {
            ...super.toTemplate(),
            rule: this.rule,
            customMod: this.customMod,
     ...
     */
    loadFromSettings(config: FalloutMaWCalendar.LeapYearData): void {
