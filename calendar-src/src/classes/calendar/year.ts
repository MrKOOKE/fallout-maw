...
export default class Year extends ConfigurationItemBase {
     ...
     */
    toConfig(): FalloutMaWCalendar.YearData {
        return {
            id: this.id,
     ...
     * @returns {FalloutMaWCalendar.HandlebarTemplateData.Year}
     */
    toTemplate(): FalloutMaWCalendar.HandlebarTemplateData.Year {
        return {
            ...super.toTemplate(),
            firstWeekday: this.firstWeekday,
            numericRepresentation: this.numericRepresentation,
     ...
     */
    loadFromSettings(config: FalloutMaWCalendar.YearData) {
