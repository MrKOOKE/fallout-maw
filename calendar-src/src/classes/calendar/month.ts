...
export default class Month extends ConfigurationItemBase {
     ...
     */
    toConfig(): FalloutMaWCalendar.MonthData {
        return {
            id: this.id,
            name: this.name,
     ...
     */
    toTemplate(calendar: Calendar | null = null): FalloutMaWCalendar.HandlebarTemplateData.Month {
     ...
     */
    loadFromSettings(config: FalloutMaWCalendar.MonthData) {
     ...
     */
    getDaysForTemplate(isLeapYear: boolean = false): FalloutMaWCalendar.HandlebarTemplateData.Day[] {
