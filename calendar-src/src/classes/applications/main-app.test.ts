...
import { CalendarClickEvents, DateTimeUnits, GameWorldTimeIntegrations, Icons, PredefinedCalendars } from "../../constants";
...
describe("Main App Class Tests", () => {
    ...
    beforeEach(async () => {
        ...
        (<any>game).users.activeGM.isSelf = false;
    });
    ...
    test("Initialize", () => {
        ...
        ma.initialize();
        expect(ma.uiElementStates["fallout-maw-calendar-note-list"]).toBe(true);
    });
    ...
    test("Get Data", () => {
        ...
        ma.uiElementStates["fallout-maw-calendar-addon-button-side-drawer-0"] = true;
        expect(ma.getData()).toBeDefined();
    });
    ...
    test("close", () => {
        ...
        ui.windows = {
            //@ts-ignore
            1: { id: "fallout-maw-calendar-application", close: jest.fn() },
            //@ts-ignore
            2: { id: "", close: jest.fn() }
        };
        ma.close();
    ...
    test("Set Width Height", () => {
        ...
        wrapper.classList.add("fallout-maw-calendar-main-wrapper");
        calendarSections.classList.add("fallout-maw-calendar-section", "fallout-maw-calendar-calendar");
        clockSections.classList.add("fallout-maw-calendar-section", "fallout-maw-calendar-clock-display");
        yearView.classList.add("fallout-maw-calendar-year-view");
        calendarHeader.classList.add("fallout-maw-calendar-calendar-header");
        calendarHeaderCurDate.classList.add("fallout-maw-calendar-current-date");
        calendarDays.classList.add("fallout-maw-calendar-days");
        calendarWeek.classList.add("fallout-maw-calendar-week");
        clock.classList.add("fallout-maw-calendar-clock");
        ...
        date.classList.add("fallout-maw-calendar-date");
        dateText.classList.add("fallout-maw-calendar-date-text");
        unitControls.classList.add("fallout-maw-calendar-unit-controls");
        controlGroup.classList.add("fallout-maw-calendar-control-group");
    ...
    test("App Drag End", () => {
        ...
        mainApp.classList.add("fallout-maw-calendar-compact-view");
        ma.appDragEnd(new Event("drag"));
    ...
    test("Activate Listeners", () => {
        ...
        expect(mainApp.classList.contains("fallout-maw-calendar-compact-view")).toBe(false);

        ma.uiElementStates.compactView = true;
        ma.activateListeners();
        expect(mainApp.classList.contains("fallout-maw-calendar-compact-view")).toBe(true);
    ...
    test("Addon Button Click", () => {
        ...
        button.setAttribute("data-fallout-maw-calendar-abi", "0");
    ...
    test("Addon Button Side Panel Content Render", () => {
        ...
        sideDrawer.classList.add("fallout-maw-calendar-addon-button-side-drawer");
        sideDrawer.setAttribute("data-fallout-maw-calendar-abi", "0");
    ...
    test("Toggle Drawers", () => {
        ...
        ma.toggleDrawer("fallout-maw-calendar-calendar-list");
        expect(ma.uiElementStates["fallout-maw-calendar-calendar-list"]).toBe(true);

        jest.spyOn(GameSettings, "GetBooleanSettings").mockReturnValue(true);
        ma.toggleDrawer("fallout-maw-calendar-calendar-list");
        expect(ma.uiElementStates["fallout-maw-calendar-calendar-list"]).toBe(false);

        ma.uiElementStates["fallout-maw-calendar-note-list"] = false;
        ma.toggleDrawer("fallout-maw-calendar-note-list");
        expect(ma.uiElementStates["fallout-maw-calendar-note-list"]).toBe(true);
    });
    ...
    test("Hide Drawers", () => {
        ...
        clElm.classList.add("fallout-maw-calendar-side-drawer", "fallout-maw-calendar-calendar-list");
        nlElm.classList.add("fallout-maw-calendar-side-drawer", "fallout-maw-calendar-note-list");
        nsElm.classList.add("fallout-maw-calendar-side-drawer", "fallout-maw-calendar-note-search");
        abElm.classList.add("fallout-maw-calendar-side-drawer", "fallout-maw-calendar-addon-button-side-drawer-0");
        ma.uiElementStates["fallout-maw-calendar-calendar-list"] = true;
        ma.uiElementStates["fallout-maw-calendar-note-list"] = true;
        ma.uiElementStates["fallout-maw-calendar-note-search"] = true;

        ma.hideDrawers(["fallout-maw-calendar-note-search"]);
        expect(ma.uiElementStates["fallout-maw-calendar-calendar-list"]).toBe(false);
        expect(ma.uiElementStates["fallout-maw-calendar-note-list"]).toBe(false);
        expect(ma.uiElementStates["fallout-maw-calendar-note-search"]).toBe(true);
        ...
        expect(ma.uiElementStates["fallout-maw-calendar-calendar-list"]).toBe(false);
        expect(ma.uiElementStates["fallout-maw-calendar-note-list"]).toBe(false);
        expect(ma.uiElementStates["fallout-maw-calendar-note-search"]).toBe(false);
        ...
        ma.uiElementStates["fallout-maw-calendar-addon-button-side-drawer-0"] = true;
        ma.hideDrawers();
        expect(ma.uiElementStates["fallout-maw-calendar-addon-button-side-drawer-0"]).toBe(false);
    });
    ...
    test("Change Calendar", () => {
        ...
        (<any>game).users.activeGM.isSelf = true;
        //@ts-ignore
        ma.changeCalendar(false, fEvent);
    ...
    test("Note Context", () => {
        ...
        note.classList.add("fallout-maw-calendar-note");
        section.classList.add("fallout-maw-calendar-section");
        contextMenu.classList.add("fallout-maw-calendar-context-menu");
        contextList.classList.add("fallout-maw-calendar-day-context-list");
        visibleAction.classList.add("fallout-maw-calendar-context-list-action");
    ...
    test("Note Context Click", () => {
        ...
        contextMenu.classList.add("fallout-maw-calendar-context-menu");
        action.classList.add("fallout-maw-calendar-context-list-action");
    ...
    test("Time Keeping Check", async () => {
        ...
        game.user.isGM = true;
        (<any>game).users.activeGM.isSelf = true;
        tCal.generalSettings.gameWorldTimeIntegration = GameWorldTimeIntegrations.Self;
        jest.spyOn(tCal, "syncTime").mockResolvedValue(true);
        jest.spyOn(CalManager, "saveCalendars").mockResolvedValue();
