...
describe("Configuration App Class Tests", () => {
    ...
    test("Predefined Calendar Click", () => {
        ...
        elm.classList.add("fallout-maw-calendar-selected");
        //@ts-ignore
        ...
        elm.classList.remove("fallout-maw-calendar-selected");
    ...
    test("Save", async () => {
        ...
        jest.spyOn(SC, "save").mockResolvedValue();
    ...
    test("Import Calendar Save", async () => {
        ...
        const data = {
            ...
            notes: {
                a: [
                    { flags: { "fallout-maw": { noteData: { calendarId: "a" } } } },
                    { flags: { "fallout-maw": { noteData: { calendarId: "a" } } } }
                ],
                b: [
                    { flags: { "fallout-maw": { noteData: { calendarId: "b" } } } },
                    { flags: { "fallout-maw": { noteData: { calendarId: "b" } } } }
                ]
            }
        };
