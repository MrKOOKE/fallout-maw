...
export function ordinalSuffix(n: number): string {
    return (
        [
            undefined,
            GameSettings.Localize("FALLOUTMAW.Calendar.OrdinalSuffix.st"),
            GameSettings.Localize("FALLOUTMAW.Calendar.OrdinalSuffix.nd"),
            GameSettings.Localize("FALLOUTMAW.Calendar.OrdinalSuffix.rd")
        ][(n % 100 >> 3) ^ 1 && n % 10] || GameSettings.Localize("FALLOUTMAW.Calendar.OrdinalSuffix.th")
    );
}
