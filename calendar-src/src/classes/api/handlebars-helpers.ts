...
export class HandlebarsHelpers {
     ...
     */
    static Register() {
        Handlebars.registerHelper("fallout-maw-calendar-date-selector", HandlebarsHelpers.DateSelector);
        Handlebars.registerHelper("fallout-maw-calendar-full-calendar", HandlebarsHelpers.FullCalendar);
        Handlebars.registerHelper("fallout-maw-calendar-clock", HandlebarsHelpers.Clock);
        Handlebars.registerHelper("fallout-maw-calendar-icon", HandlebarsHelpers.Icon);
        Handlebars.registerHelper("fallout-maw-calendar-multi-select", HandlebarsHelpers.MultiSelect);
        Handlebars.registerHelper("fallout-maw-calendar-date-time-controls", HandlebarsHelpers.DateTimeControls);
    }
    ...
    static DateSelector(options: any) {
        if (Object.prototype.hasOwnProperty.call(options.hash, "id")) {
            const dsOptions: FalloutMaWCalendar.DateTimeSelector.Options = {};
    ...
    static FullCalendar(options: any) {
        const renderOptions: FalloutMaWCalendar.Renderer.CalendarOptions = { id: "" };
        let calendarId = "";
    ...
    static Clock(options: any) {
        const renderOptions: FalloutMaWCalendar.Renderer.ClockOptions = { id: "" };
        let calendarId = "";
        if (Object.prototype.hasOwnProperty.call(options.hash, "id")) {
            renderOptions.id = options.hash["id"];
        }
    ...
    static MultiSelect(options: any) {
        const renderOptions: FalloutMaWCalendar.Renderer.MultiSelectOptions = { id: "", options: [] };
        if (Object.prototype.hasOwnProperty.call(options.hash, "id")) {
            renderOptions.id = options.hash["id"];
        }
    ...
    static DateTimeControls(options: any) {
        const renderOptions: FalloutMaWCalendar.Renderer.DateTimeControlOptions = {};
