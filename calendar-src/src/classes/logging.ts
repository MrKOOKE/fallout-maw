...
export class Logger {
    ...
    static info(message: string) {
        if (message) {
            console.info("%cFallout-MaW Calendar", "color:blue;", ` | ${message}`);
        }
    }
    ...
    static warn(message: string) {
        if (message) {
            console.warn("%cFallout-MaW Calendar", "color:orange;", ` | ${message}`);
        }
    }
    ...
    static error(message: string | Error) {
        if (message instanceof Error) {
            console.error("%cFallout-MaW Calendar", "color:red;", ` | Error "${message.message}"\n${message.stack}`);
        } else {
            console.error("%cFallout-MaW Calendar", "color:red;", ` | ${message}`);
        }
    }
    ...
    static debug(message: string) {
        if (message && Logger.debugMode) {
            console.debug("%cFallout-MaW Calendar", "color:green;", ` | ${message}`);
        }
    }
}
