...
export default class GeneralSettings extends ConfigurationItemBase {
     ...
     */
    toTemplate(): FalloutMaWCalendar.HandlebarTemplateData.GeneralSettings {
        return {
            ...super.toTemplate(),
     ...
     */
    toConfig(): FalloutMaWCalendar.GeneralSettingsData {
        return {
            id: this.id,
            gameWorldTimeIntegration: this.gameWorldTimeIntegration,
            showClock: this.showClock,
     ...
     */
    loadFromSettings(config: FalloutMaWCalendar.GeneralSettingsData) {
