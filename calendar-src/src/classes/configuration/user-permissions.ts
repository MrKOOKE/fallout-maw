...
export default class UserPermissions extends ConfigurationItemBase {
     ...
     */
    viewCalendar: FalloutMaWCalendar.PermissionMatrix;
    /**
     * Which users can add notes to the calendar
     */
    addNotes: FalloutMaWCalendar.PermissionMatrix;
    /**
     * Which users can reorder notes on calendar days
     */
    reorderNotes: FalloutMaWCalendar.PermissionMatrix;
    /**
     * Which users can change the date/time of the calendar
     */
    changeDateTime: FalloutMaWCalendar.PermissionMatrix;
    /**
     * Which users can change the active calendar
     */
    changeActiveCalendar: FalloutMaWCalendar.PermissionMatrix;
     ...
     * @private
     */
    private static clonePermissions(p: FalloutMaWCalendar.PermissionMatrix): FalloutMaWCalendar.PermissionMatrix {
        return {
            player: p.player,
     ...
     */
    toTemplate(): FalloutMaWCalendar.HandlebarTemplateData.UserPermissions {
        return {
            ...super.toTemplate(),
     ...
     */
    toConfig(): FalloutMaWCalendar.UserPermissionsData {
        return {
            id: this.id,
            addNotes: this.addNotes,
            changeDateTime: this.changeDateTime,
     ...
     */
    loadFromSettings(config: FalloutMaWCalendar.UserPermissionsData) {
