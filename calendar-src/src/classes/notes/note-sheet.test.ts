...
describe("Note Sheet Class Tests", () => {
    ...
    test("Type", () => {
        expect(ns.type).toBe("falloutmawcalendarnote");
    });
    ...
    test("Get Title", () => {
        ...
        je.name = "";
        ns.copyData();
        jest.spyOn((<Game>game).i18n!, "localize").mockReturnValue("New Note");
        expect(ns.title).toBe("New Note");
    });
    ...
    test("Get Data", async () => {
        ...
        //@ts-ignore
        ns.journalData.flags["fallout-maw"] = { noteData: { repeats: 0, macro: "none", remindUsers: [], categories: ["Holiday"] } };
        ...
        ns.journalData.flags = {
            //@ts-ignore
            "fallout-maw": { noteData: { repeats: 0, macro: "none", remindUsers: [], categories: ["Holiday"] } }
        };
        expect(await ns.getData()).toBeDefined();
        //Image page
        ...
        ns.journalData.ownership = { "": 3, a: 0, default: 0 };
        //@ts-ignore
        ns.journalData.flags = { "fallout-maw": { noteData: { repeats: 0, macro: "none", remindUsers: [], categories: [] } } };
        expect(await ns.getData()).toBeDefined();
        //PDF page
        ...
        ns.journalData.ownership = { "": 3, a: 0, default: 0 };
        //@ts-ignore
        ns.journalData.flags = { "fallout-maw": { noteData: { repeats: 0, macro: "", remindUsers: [], categories: [] } } };
        expect(await ns.getData()).toBeDefined();
    ...
    test("Input Change", async () => {
        ...
        targetParent.classList.add("fallout-maw-calendar-editor-container");
    ...
    test("Generate Image HTML", () => {
        ...
        expect(h).toContain("fallout-maw-calendar-image-placeholder");
    ...
    test("MultiSelect Option Change", () => {
        //@ts-ignore
        ns.journalData.flags["fallout-maw"] = { noteData: { categories: [] } };
        ns.multiSelectOptionChange("falloutMawCalendarNoteCategories_undefined", "Holiday", true);
        //@ts-ignore
        expect(ns.journalData.flags["fallout-maw"].noteData.categories.indexOf("Holiday") > -1).toBe(true);

        ns.multiSelectOptionChange("falloutMawCalendarNoteCategories_undefined", "Holiday", false);
        //@ts-ignore
        expect(ns.journalData.flags["fallout-maw"].noteData.categories.indexOf("Holiday") > -1).toBe(false);

        ns.multiSelectOptionChange("falloutMawCalendarUserPermissions_undefined", "123", true);
        //@ts-ignore
        ...
        ns.multiSelectOptionChange("falloutMawCalendarUserPermissions_undefined", "123", false);
        //@ts-ignore
        ...
        ns.multiSelectOptionChange("falloutMawCalendarUserPermissions_undefined", "default", false);
        //@ts-ignore
        expect(ns.journalData.ownership["default"]).toBe(0);
        //@ts-ignore
        expect(ns.journalData.ownership[""]).toBe(0);

        ns.multiSelectOptionChange("falloutMawCalendarUserPermissions_undefined", "default", true);
        //@ts-ignore
