...
describe('Renderer Calendar Full Class Tests', () => {
    ...
    test('Render and Build', () => {
        ...
        expect(HTML).toContain('fallout-maw-calendar-calendar');
        ...
        expect(HTML).toContain(`class="fallout-maw-calendar-month-year`);
        ...
        expect(HTML).toContain('fallout-maw-calendar-calendar');
        expect(HTML).toContain(`<span class="fallout-maw-calendar-month-year fallout-maw-calendar-description-clickable" data-visible="2/${d.getFullYear()}">${tCal.months[2].name} </span>`);

        HTML = CalendarFull.Render(tCal, {id: '', colorToMatchSeason: false, date: {year: d.getFullYear(), month: 2, day: 3}});
        expect(HTML).toContain('fallout-maw-calendar-calendar');
        expect(HTML).toContain(`<span class="fallout-maw-calendar-month-year fallout-maw-calendar-description-clickable" data-visible="2/${d.getFullYear()}">${tCal.months[2].name} ${d.getFullYear()}</span>`);
        ...
        expect(HTML).toContain('fallout-maw-calendar light');

        //Year View (all months)
        HTML = CalendarFull.Render(tCal, {id: '', view: CalendarViews.Year});
        expect(HTML).toContain('fallout-maw-calendar-year-view');
    ...
    test('Day Context Click', () => {
        ...
        wrapper.classList.add('fallout-maw-calendar-calendar-wrapper');
    ...
    test('Show Description', () => {
        ...
        calendarWrapper.classList.add('fallout-maw-calendar-calendar-wrapper');
        calendar.classList.add('fallout-maw-calendar-calendar');
        calendarHeader.classList.add('fallout-maw-calendar-calendar-header');
        monthYear.classList.add('fallout-maw-calendar-month-year');
        descriptions.classList.add('fallout-maw-calendar-descriptions');
        target.classList.add('fallout-maw-calendar-day');
        contextMenu.classList.add('fallout-maw-calendar-day-context-list');
        contextMenuTitle.classList.add('fallout-maw-calendar-context-list-title');
        sunriseSunset.classList.add('fallout-maw-calendar-sunrise-sunset');
        sunrise.classList.add('fallout-maw-calendar-sunrise');
        sunset.classList.add('fallout-maw-calendar-sunset');
        ...
        expect(description.classList.contains('fallout-maw-calendar-hide')).toBe(false);
        expect(contextMenu.classList.contains('fallout-maw-calendar-hide')).toBe(true);
    ...
    test('Hide Description', () => {
        ...
        expect(descriptions.classList.contains('fallout-maw-calendar-hide')).toBe(false);
        CalendarFull.HideDescription();
        expect(descriptions.classList.contains('fallout-maw-calendar-hide')).toBe(true);
    ...
    test('Note Indicator', () => {
        ...
        expect(CalendarFull.NoteIndicator(tCal, 0, 0, 0)).toBe('<span class="fallout-maw-calendar-note-count" data-tooltip=":\nN2">1</span><span class="fallout-maw-calendar-note-count fallout-maw-calendar-reminders" data-tooltip=":\nN1">1</span>');
        ...
        expect(CalendarFull.NoteIndicator(tCal, 0, 0, 0)).toBe('<span class="fallout-maw-calendar-note-count fallout-maw-calendar-reminders" data-tooltip="99 ">99</span>');
        ...
        expect(CalendarFull.NoteIndicator(tCal, 0, 0, 0)).toBe('<span class="fallout-maw-calendar-note-count" data-tooltip="99 ">99</span>');
    });
    ...
    test('Moon Phase Icons', () => {
        ...
        expect(CalendarFull.MoonPhaseIcons(tCal, 0, 0, 0)).toBe('<span class="fallout-maw-calendar-moon-phase waxing-crescent" data-tooltip="Moon - Waxing Crescent"></span>');

        tCal.moons.push(new Moon('a'));
        tCal.moons.push(new Moon('b'));
        tCal.moons.push(new Moon('c'));
        expect(CalendarFull.MoonPhaseIcons(tCal, 0, 0, 0)).toContain('fallout-maw-calendar-moon-group-wrapper');
        expect(CalendarFull.MoonPhaseIcons(tCal, 0, 0, 0, true, true)).toContain('fallout-maw-calendar-left');
    });
});
