...
describe('Renderer DateTimeControls Class Tests', () => {
    test("Render", () => {
        const options = {
            ...
            fullDisplay:{
                unit: 'seconds',
                unitText: 'FALLOUTMAW.Calendar.Second',
                dateTimeUnitOpen: true
            },
            largerSteps: false,
            reverseTime: false
        };
        expect(DateTimeControls.Render()).toContain('fallout-maw-calendar-unit-controls');
        expect(DateTimeControls.Render(options)).toContain('fallout-maw-calendar-open');
        options.fullDisplay.unit = "round";
        expect(DateTimeControls.Render(options)).toContain('fallout-maw-calendar-selected');
        ...
        expect(DateTimeControls.Render(options)).toContain('fallout-maw-calendar-control-group');
