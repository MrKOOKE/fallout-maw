...
describe('Renderer MultiSelect Class Tests', () => {
    ...
    test('Render', () => {
        expect(MultiSelect.Render()).toContain("fallout-maw-calendar-multiselect");
        expect(MultiSelect.Render({id: '', options: [{selected: true, value: "val1", text: "Option 1"},{selected: false, value: "val2", text: "Option 2"},{selected: false, value: "val3", text: "Option 3", disabled: true}]}, true)).toContain("fallout-maw-calendar-show");
    });
    ...
    test('Event Listener', () => {
        ...
        expect(msElm.classList.contains('fallout-maw-calendar-show')).toBe(true);

        MultiSelect.EventListener('', 'button', ()=>{}, new Event('click'));
        expect(msElm.classList.contains('fallout-maw-calendar-show')).toBe(false);
